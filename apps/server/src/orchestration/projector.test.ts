      ...
      projectEvent(
        ...
        makeEvent({
          ...
          payload: {
            ...
            turnId: "turn-checkpoint-stage-1",
            turnCount: 1,
            ref: "refs/forge/checkpoints/thread-checkpoint-stage/turn/1",
            capturedAt,
          },
        }),
      ),
    ...
    const events: ReadonlyArray<ForgeEvent> = [
      ...
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: "refs/forge/checkpoints/thread-1/turn/2",
          status: "ready",
          files: [],
    ...
    const events: ReadonlyArray<ForgeEvent> = [
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-1",
          checkpointTurnCount: 1,
          checkpointRef: "refs/forge/checkpoints/thread-revert/turn/1",
          status: "ready",
          files: [],
      ...
      makeEvent({
        ...
        payload: {
          ...
          turnId: "turn-2",
          checkpointTurnCount: 2,
          checkpointRef: "refs/forge/checkpoints/thread-revert/turn/2",
          status: "ready",
          files: [],
    ...
    const checkpointEvents: ReadonlyArray<ForgeEvent> = Array.from({ length: 600 }, (_, index) =>
      makeEvent({
        ...
        payload: {
          ...
          checkpointRef: `refs/forge/checkpoints/thread-capped/turn/${index + 1}`,
          status: "ready",
          files: [],
