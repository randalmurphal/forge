...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("forge-projection-pipeline-test-");
        ...
        yield* projectionPipeline.projectEvent(
          makeForgeEvent({
            ...
            payload: {
              ...
              turnId: "turn-staged-1",
              turnCount: 1,
              ref: "refs/forge/checkpoints/thread-staged-turn/turn/1",
              capturedAt,
            },
          }),
        );
        ...
        assert.deepEqual(turnRowsBeforeRevert, [
          {
            ...
            checkpointRef: "refs/forge/checkpoints/thread-staged-turn/turn/1",
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-base-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-projection-attachments-safe-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.makeUnsafe(
            "refs/forge/checkpoints/thread-revert-files/turn/1",
          ),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointRef: CheckpointRef.makeUnsafe(
            "refs/forge/checkpoints/thread-revert-files/turn/2",
          ),
          status: "ready",
          files: [],
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("forge-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.makeUnsafe(
              "refs/forge/checkpoints/thread-conflict/turn/1",
            ),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.makeUnsafe("refs/forge/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.makeUnsafe("refs/forge/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "forge-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "forge-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
