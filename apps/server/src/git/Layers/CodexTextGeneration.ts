...
import { CodexModelSelection } from "@forgetools/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@forgetools/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `forge-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
