...
import Migration0020 from "./Migrations/020_WorkflowTables.ts";
import Migration0021 from "./Migrations/021_ChannelTables.ts";
import Migration0022 from "./Migrations/022_ThreadExtensions.ts";
import Migration0023 from "./Migrations/023_PhaseOutputTables.ts";
...
import Migration0032 from "./Migrations/032_ProjectionAgentDiffAssistantMessageId.ts";
import Migration0033 from "./Migrations/033_ProjectionThreadsForkedFrom.ts";
import Migration0034 from "./Migrations/034_ProjectionThreadsPinnedAt.ts";
import Migration0035 from "./Migrations/035_ProjectionThreadMessageSequence.ts";
import Migration0036 from "./Migrations/036_ProjectionThreadProposedPlanHistory.ts";
import Migration0037 from "./Migrations/037_ProjectionAgentDiffHistory.ts";
import Migration0038 from "./Migrations/038_ProjectionCheckpointHistory.ts";
...
export const migrationEntries = [
  ...
  [20, "WorkflowTables", Migration0020],
  [21, "ChannelTables", Migration0021],
  [22, "ThreadExtensions", Migration0022],
  [23, "PhaseOutputTables", Migration0023],
  ...
  [32, "ProjectionAgentDiffAssistantMessageId", Migration0032],
  [33, "ProjectionThreadsForkedFrom", Migration0033],
  [34, "ProjectionThreadsPinnedAt", Migration0034],
  [35, "ProjectionThreadMessageSequence", Migration0035],
  [36, "ProjectionThreadProposedPlanHistory", Migration0036],
  [37, "ProjectionAgentDiffHistory", Migration0037],
  [38, "ProjectionCheckpointHistory", Migration0038],
] as const;
