 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@forgetools/contracts";
...
>()("forge/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
