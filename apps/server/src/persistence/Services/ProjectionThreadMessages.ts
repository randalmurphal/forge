...
export interface ProjectionThreadMessageRepositoryShape {
   ...
   *
   * Returned in ascending visible order, preferring persisted sequence when present.
   */
...
>()("forge/persistence/Services/ProjectionThreadMessages/ProjectionThreadMessageRepository") {}
