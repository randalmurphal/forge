...
export const ProjectionThread = Schema.Struct({
  ...
  spawnBranch: Schema.optional(Schema.NullOr(Schema.String)),
  spawnWorktreePath: Schema.optional(Schema.NullOr(Schema.String)),
...
>()("forge/persistence/Services/ProjectionThreads/ProjectionThreadRepository") {}
