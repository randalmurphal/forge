...
export interface CheckpointStoreShape {
  ...
  /**
   * Compute a patch diff between a checkpoint ref and the current working tree,
   * restricted to the provided repo-relative paths.
   */
...
export class CheckpointStore extends ServiceMap.Service<CheckpointStore, CheckpointStoreShape>()(
  "forge/checkpointing/Services/CheckpointStore",
) {}
