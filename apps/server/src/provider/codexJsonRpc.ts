/**
 * JSON-RPC protocol types and type guards for the Codex app-server wire format.
 *
 * All functions are pure (no `this`, no side effects) and operate solely on
 * unknown JSON values received from the Codex child process stdout.
 *
 * @module codexJsonRpc
 */
