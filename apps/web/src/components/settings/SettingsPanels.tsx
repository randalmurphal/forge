...
import { DEFAULT_UNIFIED_SETTINGS } from "@forgetools/contracts/settings";
...
function getProviderSummary(provider: ServerProvider | undefined) {
  ...
  if (!provider.enabled) {
    return {
      headline: "Disabled",
      detail:
        provider.message ?? "This provider is installed but disabled for new sessions in Forge.",
    };
  }
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Forge looks across the app."
          resetAction={
            theme !== "system" ? (
