...
import type { SessionPhase, ThreadSession, TurnDiffSummary } from "../types";
...
export function shouldInsertBackgroundCompletionBefore(
...
export function earliestIsoValue(
...
export function latestIsoValue(
  previous: string | undefined,
  next: string | undefined,
): string | undefined {
  if (!previous) return next;
