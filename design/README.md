...
3. Workflow engine (04) - phases, gates, basic loops
4. Correction system (06) - guidance channels, context injection
5. Notifications (07) - OS-native, in-app

**Advanced features (build on core):**
6. Deliberation (08) - multi-agent, channel tools
7. Channel system and deliberation (11, 12)
...
10. Workflow editor UI (05)
11. Workflow templates and customization
12. Cost tracking and budget controls
13. Agent recovery and replay
