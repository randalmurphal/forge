...
| [02-data-model.md](./02-data-model.md) | *(Superseded by doc 13)* Tasks, workflows, phases, sessions, channels |
| [03-effect-removal.md](./03-effect-removal.md) | Stripping Effect.js from t3-code, replacement patterns |
...
| [10-schemas.md](./10-schemas.md) | *(Schemas superseded by doc 13)* Startup sequence, shutdown policy, state ownership, quality checks, daemon transport |
...
| [13-sessions-first-redesign.md](./13-sessions-first-redesign.md) | Sessions-first redesign: Session replaces Task as the primary entity |
...
1. Effect.js removal (03) - unblocks all server work
2. Sessions-first data model (13) - thread-centric -> session-centric
3. Basic workspace UI (05) - session sidebar + session view

**Core features (build on foundation):**
4. Workflow engine (04) - phases, gates, basic loops
5. Correction system (06) - guidance channels, context injection
6. Notifications (07) - OS-native, in-app

**Advanced features (build on core):**
7. Deliberation (08) - multi-agent, channel tools
8. Daemon mode (07) - background execution, socket API, CLI
9. Build loop workflow (04) - quality checks, iteration context

**Polish (after core works):**
10. Workflow templates and customization
11. Cost tracking and budget controls
12. Agent recovery and replay
